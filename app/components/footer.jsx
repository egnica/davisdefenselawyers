...
const areasServed = Location.areas || [];
      ...
      <div className={styles.footerInner}>
        <div className={styles.footerTop}>
          <div className={styles.footerBrand}>
            <span className={styles.footerBrandMark}>AD</span>
            <div>
              <strong>Davis Defense</strong>
              <span>Minnesota criminal defense</span>
            </div>
          </div>
          ...
          <div className={styles.socials}>
            <a
              href="https://www.facebook.com/Daviscriminaldefense"
              target="_blank"
              rel="noreferrer"
              aria-label="Davis Defense on Facebook"
            >
            ...
            <a
              href="https://www.linkedin.com/in/andrew-davis-aa4aa253/"
              target="_blank"
              rel="noreferrer"
              aria-label="Andrew Davis on LinkedIn"
            >
              <svg viewBox="0 0 640 640" aria-hidden="true">
            ...
            <a
              href="https://www.youtube.com/@AndrewDavisAttorney"
              target="_blank"
              rel="noreferrer"
              aria-label="Andrew Davis on YouTube"
            >
              <svg viewBox="0 0 640 640" aria-hidden="true">
        ...
        <div className={styles.footerColumns}>
          ...
          <nav aria-label="Footer service areas">
            ...
            <div className={styles.footerLocationGrid}>
        ...
        <div className={styles.footerBottom}>
          ...
          <a href="https://nicholasegner.com" target="_blank" rel="noreferrer">
            <NElogo width={42} />
            <span>Nicholas Egner · Web Development</span>
          </a>
        </div>
      </div>
    </footer>
